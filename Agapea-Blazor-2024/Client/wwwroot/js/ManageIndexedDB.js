...
window.adminIndexedDB = {
    almacenarDatosCliente: (datoscliente) => {
        ...
        _reqDB.addEventListener('success', (ev) => {
            ...
            _reqInsertDatosCliente.addEventListener('error', (err) => { console.log(`error al recuperar datoscliente con emnail: ${datoscliente.credenciales.email}...`, err); _transacDatosCliente.abort(); });
