...
BULK 'C:\Users\thard\source\repos\Agapea-Blazor-2024\provincias.json', SINGLE_NCLOB
) AS [Json]
...
BULK 'C:\Users\thard\source\repos\Agapea-Blazor-2024\municipios.json', SINGLE_NCLOB
) AS [Json]
CROSS APPLY OPENJSON (BulkColumn, '$')
WITH (
CPRO nvarchar(max) '$.CPRO',
